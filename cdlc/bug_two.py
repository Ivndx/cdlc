...
class BugTwo(Node):
    ...
    def follow_wall(self, direction):
        ...
        dwall, betha, Kfw = 0.50, 0.55, 1.00
        ...
        v = 0.075 if abs(fw_angle) > 0.1 else 0.2
        w = Kfw * fw_angle
        self.move_robot(v, w)
    ...
    def lineAgainWithProgress(self):
        ...
        progress_check = current_progress > self.progress_at_hit
